    ...
    return(
        <div className='portfolio'>
            <div className='curves'>
                ...
                <CurveTR width='45vw' height='20.6vh' left='0vw' top='358.7vh' thickness='2vw' radius='4vw' colors={[color1, color2, color3]} />
                <CurveV height='30vh' left='39.0vw' top='379.3vh' thickness='2vw' radius='4vw' colors={[color1, color2, color3]} />
                <CurveBL width='59.9vw' height='24.3vh' left='39.0vw' top='409.3vh' thickness='2vw' radius='4vw' colors={[color3, color2, color1]} />
            </div>
