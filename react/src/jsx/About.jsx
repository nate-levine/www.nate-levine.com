    ...
    return(
        <div className='about'>
            ...
            <div className='content'>
                <Header />
                <Popbox width='50vw' height='10vh' left='1vw' top='37vh' color={[color1]} delay='0s' duration='0.5s' textDuration='0.4s' textDelay='0s' title="I'm a Junior at Worcester Polytechnic Institute." /> 
                <Popbox width='30vw' height='10vh' left='1vw' top='90vh' color={[color2]} delay='0.4s' duration='0.5s' textDuration='0.4s' textDelay='0.4s'  title='Web Development &' /> 
                <Popbox width='30vw' height='10vh' left='10vw' top='100vh' color={[color3]} delay='0s' duration='0.5s' textDuration='0.4s' textDelay='0s'  title='Graphics Programming' />
                <Popbox width='12vw' height='10vh' left='2vw' top='125vh' color={[color1]} delay='0s' duration='0.5s' textDuration='0.4s' textDelay='0s'  title='Cooking' />
                <Popbox width='11vw' height='10vh' left='11vw' top='145vh' color={['#000000']} textColor='#ffffff' delay='0s' duration='0.5s' textDuration='0.4s' textDelay='0s'  title='Fitness' /> 
                ...
                <Popbox width='45vw' height='9vh' left='50vw' top='52vh' color={['#000000']} textColor='#ffffff' delay='0.2s' duration='0.5s' textDuration='0.4s' textDelay='0.2s'  title='pursuing a B.S. in Mechanical Engineering' /> 
                ...
                <div className='section' style={{ height:'75vh', backgroundColor: 'transparent' }}>
                    ...
                    <h3 style={{ position: 'absolute', width: '35vw', left: '15vw', top: '127vh', margin: 0 }}>is more than a life skill. Understanding and applying the chemistry behind what makes good food is a constant goal for me.</h3>
                    <h3 style={{ position: 'absolute', width: '40vw', left: '23vw', top: '147vh', margin: 0 }}>Going to the gym, going for a run, or playing pickup basketball is an essential. It keeps me relaxed and focused daily.</h3>
                </div>
            </div>
        </div>
    );
